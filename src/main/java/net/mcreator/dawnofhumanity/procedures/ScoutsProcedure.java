	...
	public static void execute(CommandContext<CommandSource> arguments) {
		{
			...
			if (!_ent.world.isRemote() && _ent.world.getServer() != null)
				...
				}.getEntity()).getCapability(DohessModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DohessModVariables.PlayerVariables())).Counter + " color blue"));
		}
	}
}
