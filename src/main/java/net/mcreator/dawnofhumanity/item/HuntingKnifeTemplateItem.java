...
import net.mcreator.dawnofhumanity.procedures.HuntingKnifeTemplateUseProcedure;
import net.mcreator.dawnofhumanity.init.DohessModTabs;

public class HuntingKnifeTemplateItem extends Item {
	public HuntingKnifeTemplateItem() {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
		...
		HuntingKnifeTemplateUseProcedure.execute(entity);
		return ar;
	}
}
