package net.mcreator.dawnofhumanity.world.inventory;
...
public class SquadRegimentChooseMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public SquadRegimentChooseMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(DohessModMenus.SQUAD_REGIMENT_CHOOSE.get(), id);
