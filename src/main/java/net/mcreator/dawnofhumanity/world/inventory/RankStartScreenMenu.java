...
public class RankStartScreenMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public RankStartScreenMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(DohessModMenus.RANK_START_SCREEN.get(), id);
